...
class ThighHighsRenderer : EquipRenderer {
    ...
    override fun render(
        ...
        val style = EstrogenItems.ThighHighs.get().getStyle(stack)
        ...
        if (style != null) {
            ...
            val baseColor = (EstrogenItems.ThighHighs.get().getColor(stack, 0)) alpha 255
            ...
            val overlayColor = (EstrogenItems.ThighHighs.get().getColor(stack, 1)) alpha 255
