...
import dev.mayaqq.estrogen.content.recipes.CreativelessShapedRecipe
...
object EstrogenRecipes : Registrar<RecipeType<*>> by Estrogen..Registries.RECIPE_TYPE {
    ...
    val CREATIVELESS_SHAPED_RECIPE by recipeType<CreativelessShapedRecipe>("creativeless_shaped")
    ...
    object Serializers : Registrar<RecipeSerializer<*>> by sibling(Registries.RECIPE_SERIALIZER) {
        ...
        val CREATIVELESS_SHAPED_RECIPE_SERIALIZER by entry("creativeless_shaped", { ShapedRecipe.Serializer() }) {}
