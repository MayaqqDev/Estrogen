...
interface IPlayerModel {
    ...
    fun `estrogen$renderBoobArmorTrim`(stack: PoseStack, bufferSource: MultiBufferSource, light: Int, glint: Boolean, trim: ArmorTrim, material: ArmorMaterial, trimAtlas: TextureAtlas, player: AbstractClientPlayer)
}
...
fun EntityModel<*>.renderBoobArmorTrim(stack: PoseStack, bufferSource: MultiBufferSource, light: Int, glint: Boolean, trim: ArmorTrim, material: ArmorMaterial, trimAtlas: TextureAtlas, player: AbstractClientPlayer) {
