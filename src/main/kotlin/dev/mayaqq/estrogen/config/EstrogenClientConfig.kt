...
object EstrogenClientConfig {
    ...
    object ChestFeature {
        ...
        var bounciness: /*@DecimalRange(0.0, 1.0)*/ Double /* by observable(0.27) { chestConfigSet = false } */ = 0.27

        //@Comment("Chest feature physics damping")
        var damping: /*@DecimalRange(0.0, 1.0) */ Float /* by observable(0.375f) { chestConfigSet = false } */ = 0.375F
