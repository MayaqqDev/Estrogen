...
public class MothModel extends AgeableHierarchicalModel<MothEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition ass = partdefinition.addOrReplaceChild("ass", CubeListBuilder.create(), PartPose.offset(0.0F, 16.0F, 4.0F));
        ...
        PartDefinition fur7_r1 = ass.addOrReplaceChild("fur7_r1", CubeListBuilder.create().texOffs(44, 25).addBox(-8.0F, -13.0F, -5.0F, 0.0F, 10.0F, 10.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 26).addBox(-9.0F, -11.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, -4.0F, 0.0F, 1.5708F, 0.0F));
        ...
        PartDefinition back_legs_r1 = legs.addOrReplaceChild("back_legs_r1", CubeListBuilder.create().texOffs(16, 23).addBox(-3.0F, -4.0F, -3.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(30, 23).addBox(3.0F, -4.0F, -3.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
    ...
    public void setupAnim(MothEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.isFlying()) {
            this.animate(entity.flying, MothAnimations.flying, ageInTicks);
        } else {
            this.animate(entity.idle, MothAnimations.idle, ageInTicks);
        }
    }
