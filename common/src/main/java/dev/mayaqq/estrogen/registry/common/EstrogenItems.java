...
public class EstrogenItems {
    ...
    public static final ItemEntry<HorseUrineBottleItem> HORSE_URINE_BOTTLE = REGISTRATE.item("horse_urine_bottle", HorseUrineBottleItem::new)
            ...
            .register();
    public static final ItemEntry<? extends Item> ESTROGEN_PATCHES = PlatformSpecificRegistry.getRegisteredPatchesItem(EstrogenConfig.common().estrogenPatchesStackSize.get());
