...
public class EstrogenFoodComponents {
    ...
    public static final FoodProperties ESTROGEN_CHIP_COOKIE = (new FoodProperties.Builder()).effect(new MobEffectInstance(EstrogenEffects.ESTROGEN_EFFECT, 3000, 0), 1).nutrition(8).saturationMod(1.5F).fast().alwaysEat().build();
