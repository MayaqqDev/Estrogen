...
public class EstrogenConfig {
    ...
    public static class Common extends ConfigBase {
        public final ConfigGroup estrogen = group(0, "estrogen", "Settings for the estrogen patches");
        public final ConfigInt estrogenPatchesStackSize = i(4, 1, 64, "estrogenPatchesStackSize", "The stack size limit of estrogen patches", ConfigAnnotations.RequiresRestart.BOTH.asComment());
