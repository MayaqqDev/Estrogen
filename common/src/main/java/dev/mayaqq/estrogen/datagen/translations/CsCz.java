...
public class CsCz extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder tb) {
        // Status Effects
        tb.add(EstrogenEffects.ESTROGEN_EFFECT.get(), "Holčičí síla");
        ...
        tb.add(EstrogenItems.HORSE_URINE_BOTTLE.get(), "Lahvička s Koňskou Močí");
        ...
        // Potion
        tb.add("item.minecraft.tipped_arrow.effect.estrogen", "Šíp Holčičí Síly");
        tb.add("item.minecraft.potion.effect.estrogen", "Lektvar Holčičí Síly");
        tb.add("item.minecraft.splash_potion.effect.estrogen", "Vrhací Lektvar Holčičí Síly");
        tb.add("item.minecraft.lingering_potion.effect.estrogen", "Doznívající Lektvar Holčičí Síly");
        // Buckets
        tb.add(EstrogenItems.LIQUID_ESTROGEN_BUCKET.get(), "Kbelík Tekutého Estrogenu");
        tb.add(EstrogenItems.HORSE_URINE_BUCKET.get(), "Kbelík Koňské Moči");
        tb.add(EstrogenItems.FILTRATED_HORSE_URINE_BUCKET.get(), "Kbelík Filtrované Koňské Moči");
        tb.add(EstrogenItems.MOLTEN_SLIME_BUCKET.get(), "Kbelík Rozpuštěného Slizu");
        tb.add(EstrogenItems.MOLTEN_AMETHYST_BUCKET.get(), "Kbelík Rozpuštěného Ametystu");
        tb.add(EstrogenItems.TESTOSTERONE_MIXTURE_BUCKET.get(), "Kbelík Testosteronové Směsi");
        ...
        // Fluids
        tb.add("fluid_type.estrogen.liquid_estrogen", "Tekutý Estrogen");
        tb.add("fluid_type.estrogen.horse_urine", "Koňská Moč");
        tb.add("fluid_type.estrogen.filtrated_horse_urine", "Filtrovaná Koňská Moč");
        tb.add("fluid_type.estrogen.molten_slime", "Rozpuštěný Sliz");
        tb.add("fluid_type.estrogen.molten_amethyst", "Rozpuštěný Ametyst");
        tb.add("fluid_type.estrogen.testosterone_mixture", "Testosteronová Směs");
