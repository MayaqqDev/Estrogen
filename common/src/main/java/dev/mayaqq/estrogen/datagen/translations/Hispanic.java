...
public class Hispanic {
    public static void addAll(FabricDataGenerator pack) {
    ...
    public static class EsAr extends SpanishLanguageProvider {
        public EsAr(FabricDataGenerator output) {
            super(output, "es_ar");
        }
    }

    public static class EsCl extends SpanishLanguageProvider {
        public EsCl(FabricDataGenerator output) {
            super(output, "es_cl");
        }
    }

    public static class EsEs extends SpanishLanguageProvider {
        public EsEs(FabricDataGenerator output) {
            super(output, "es_es");
        }
        @Override
    ...
    public static class EsMx extends SpanishLanguageProvider {
        public EsMx(FabricDataGenerator output) {
            super(output, "es_mx");
        }
    }

    public static class EsUy extends SpanishLanguageProvider {
        public EsUy(FabricDataGenerator output) {
            super(output, "es_uy");
        }
    }

    public static class EsVe extends SpanishLanguageProvider {
        public EsVe(FabricDataGenerator output) {
            super(output, "es_ve");
        }
    }
    ...
    public static class SpanishLanguageProvider extends FabricLanguageProvider {
        public SpanishLanguageProvider(FabricDataGenerator output, String language) {
